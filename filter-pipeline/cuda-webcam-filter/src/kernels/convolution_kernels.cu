...
// Input from OpenCV is BGR: channel 0=B, 1=G, 2=R
...
// Extended Reinhard (Reinhard et al. 2002): L_out = L*(1+L/white²)/(1+L)
...
// Per-channel ACES filmic tone map
...
// Pass 1 of Local Reinhard: uint8+exposure → float
...
// Pass 2 of Local Reinhard: 9x9 neighbourhood average in shared memory
